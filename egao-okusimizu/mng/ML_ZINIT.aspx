<%@ Page  Language="C#"  ValidateRequest="true"  AutoEventWireup="true" CodeFile="ML_ZINIT.aspx.cs" Inherits="_default" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
 ...
 <div class="login-box">
  ...
  <div class="login-box-body">
        ...
        <form name="form2" id="form2" method="post" onsubmit="return chk();">  <input type="hidden" name="b1" />
            ...
            <a class="btn btn-primary btn-block" href="#"  onclick="form2.b1.value='SAV';form2.submit();">初始化</a>
            <a class="btn btn-primary btn-block" href="#"  onclick="form2.b1.value='ENC';form2.submit();">加密</a>
