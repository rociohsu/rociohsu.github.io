...
public partial class _default : MLBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (mmode)
        {
            case "A":
                ...
                break;
            case "A2":
                msqlcom.CommandText = "select * from CA2019_PDT_TYP a where fsno=@fsno";
                dv1 = aa.dv_param(msqlcom, ref mmsg);
                if (dv1 != null) mc = dv1.Count + 1;
                else mc = 1;

                mSql = "insert into CA2019_PDT_TYP (nam,fsno,sot,crt_uno,crt_usr) ";
            ...
            case "M":
                ...
                msqlcom.CommandText = "select * from CA2019_PDT_TYP where sno=@sno";
            ...
            case "M2":
                ...
                mSql = "update CA2019_PDT_TYP set nam=@nam where sno=@sno";
                msqlcom.CommandText = mSql;
                if (!aa.exec_param(msqlcom, ref mmsg))
                {
            ...
            case "D":
                ...
                //msqlcom.Parameters.Add("@sno", SqlDbType.Int, 10).Value = msno;
                msqlcom.CommandText= "delete from CA2019_PDT_TYP where sno=@sno";
                if (!aa.exec_param(msqlcom, ref mmsg))
                {
    ...
    protected void del(int ito)
    {
        ...
        using (System.Data.SqlClient.SqlCommand mndm = new System.Data.SqlClient.SqlCommand())
        {
            ...
            mndm.CommandText = "select * from CA2019_PDT_TYP where fsno=@mito";
            ...
            if (dv1 != null)
            {
                for (int i = 0; i <= dv1.Count - 1; i++)
                {
                    ...
                    mndm.CommandText = "delete from CA2019_PDT_TYP where fsno=@mito";
    ...
    protected void savsot(int xfsno)
    {
        ...
        using (System.Data.SqlClient.SqlCommand mndm = new System.Data.SqlClient.SqlCommand())
        {
            ...
            mndm.CommandText = "select sno,sot from CA2019_PDT_TYP a where fsno=@fsno order by sot";
            dv1 = aa.dv_param(mndm, ref mmsg);
            if (dv1 != null)
            {
                for (int i = 0; i <= dv1.Count - 1; i++)
                {
                    ...
                    mndm.CommandText = "update CA2019_PDT_TYP set sot=@msot where sno=@msno";
                    if (!aa.exec_param(mndm, ref mmsg))
                    {
    ...
    {
        using (SqlCommand msql = new SqlCommand("select * from CA2019_PDT_TYP where fsno=@fsno and sno<>@sno and sot>=@sot order by sot"))
        {
            ...
            if (dv1 != null)
            {
                for (int i = 0; i < dv1.Count; i++)
                {
                    ...
                    msql.CommandText = "update CA2019_PDT_TYP set sot=@sot where sno=@sno";
    ...
    protected string menu1(int ito, int mcc, int mcnt, string maa, int msts, int msts2)  //mcnt,本層筆數,msts父層筆數,msts2=目前的父層為第几筆
    {
        ...
        using (System.Data.SqlClient.SqlCommand sqlcom = new System.Data.SqlClient.SqlCommand())
        {
            ...
            sqlcom.CommandText = "select a.sno,a.nam,a.sot,a.cnt,count(b.sno) as cnt2 from CA2019_PDT_TYP(nolock) a left outer join ca2019_pdt(nolock) b on a.sno=b.typ and b.pub=1 where a.fsno=@ito group by a.sno,a.nam,a.sot,a.cnt order by a.sot";
