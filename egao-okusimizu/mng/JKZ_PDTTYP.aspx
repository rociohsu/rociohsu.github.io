<%@ Page  Language="C#"  ValidateRequest="true" MasterPageFile="_ML.master" AutoEventWireup="true" CodeFile="JKZ_PDTTYP.aspx.cs" Inherits="_default" %>
...
<input type="hidden" name="mode" value="<%=mmode%>" />
    ...
    { %>修改單元<%} %></h3>　</div>
						...
						<%}%>	
                            ...
                            msqlcom.CommandText = "select sno from CA2019_PDT_TYP a where fsno=0 " + whr + " order by sot";
