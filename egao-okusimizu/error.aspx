<%@ Page  Language="C#"  ValidateRequest="true" AutoEventWireup="true" CodeFile="error.aspx.cs" Inherits="_default" %>
<html>
<head>
    <meta content="text/html; charset=utf-8" http-equiv="content-type" />
    <title>A2B ERROR Page</title>
   ...
   <main class="g-height-100x g-min-height-100vh g-flex-centered g-pa-15">
    <div class="text-center g-flex-centered-item g-position-rel">
      ...
      <div class="g-absolute-centered">
        ...
        <p class="g-color-white-opacity-0_6 g-font-size-18">If you think this is a problem with us, please&nbsp;<a href="/contact" class="g-color-white g-color-primary--hover g-text-no-underline--hover">tell us</a>.</p>
